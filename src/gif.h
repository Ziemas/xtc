...
#define PACK_GIFTAG(Q, D0, D1) Q->dw[0] = (uint64)(D0), Q->dw[1] = (uint64)(D1)
...
#define GIF_SET_ST(S, T) (uint64)((S) & 0xFFFFFFFF) << 0 | (uint64)((T) & 0xFFFFFFFF) << 32

#define GIF_SET_UV(U, V) (uint64)((U) & 0x00003FFF) << 0 | (uint64)((V) & 0x00003FFF) << 16
